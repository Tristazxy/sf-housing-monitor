    ...
    <html lang="en">
      <body className={`${inter.className} bg-slate-900 text-white min-h-screen`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <Link href="/" className="flex items-center gap-2.5 group">
                ...
                <div>
                  <span className="font-bold text-white text-base leading-none">SF Housing</span>
                  <span className="text-blue-400 font-bold text-base leading-none"> Monitor</span>
                </div>
              </Link>
        ...
        <footer className="mt-16 border-t border-slate-800 py-6 text-center text-slate-600 text-xs">
          SF Housing Monitor — scrapes Craigslist, Zillow, Apartments.com, HotPads, PadMapper
        </footer>
      </body>
    </html>
  );
